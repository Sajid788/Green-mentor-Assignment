  ...
  return (
    <>
      <header className='bg-gradient-to-br from-blue-300 to-blue-100 flex justify-between sticky top-0 p-4  shadow-sm items-center'>
        <h2 className='cursor-pointer uppercase font-medium  text-gradient-to '>
          <Link to="/" className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-900"> Task Manager </Link>
        </h2>
        <ul className='hidden md:flex gap-4  font-medium'>
          {authState.isLoggedIn ? (
            ...
            <li className='bg-blue-500 py-2 px-4  text-white cursor-pointer text-green hover:bg-blue-600 font-medium rounded-md '><Link to="/login">Login</Link></li>
          )}
        </ul>
